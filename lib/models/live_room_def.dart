...
class RoomInfo {
  ...
  RoomInfo(
      {required this.roomId, this.roomName, this.coverUrl, this.memberCount, required this.ownerId, this.ownerName});
}
...
class MemberListCallback {
  ...
  MemberListCallback({this.code = 0, this.desc = '', this.nextSeq = 0, this.list});
}
...
class UserListCallback {
  ...
  UserListCallback({this.code = 0, this.desc = '', this.list, this.nextSeq = 0});
}
